...
import { FileText, RotateCcw, CheckCircle, AlertCircle, Home, Download } from 'lucide-react';
...
export function FinalReport({ questions, timeSpent, onRestart }: FinalReportProps) {
  ...
  const handleDownload = useCallback(() => {
    ...
    let content = `IELTS Reading Test - Answer Sheet\n`;
    content += `${'='.repeat(50)}\n\n`;
    content += `Date: ${date}\n`;
    ...
    a.href = url;
    a.download = `IELTS_Reading_Answers_${new Date().toISOString().split('T')[0]}.txt`;
