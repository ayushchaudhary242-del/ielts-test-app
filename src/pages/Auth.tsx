...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-ielts-grey flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-t-4 border-t-ielts-yellow">
        <CardHeader className="text-center">
          <div className="mx-auto mb-4 w-16 h-16 bg-ielts-header rounded-full flex items-center justify-center">
            <span className="text-ielts-yellow font-bold text-xl">IELTS</span>
          </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-ielts-yellow text-ielts-header hover:bg-ielts-yellow/90 font-bold"
              disabled={isLoading}
            >
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-ielts-blue hover:underline text-sm"
              disabled={isLoading}
            >
              {isLogin 
